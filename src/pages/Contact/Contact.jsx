...
const Contact = () => {
  return (
    <div>
      <Navbar />
      <div className="relative mx-auto w-full  text-gray-700 font-alk bg-[#F3ECB0] my-8 pt-8">
        <div className="grid grid-cols-2">
            ...
            <form className="mx-auto max-w-xl space-y-4">
              <div>
                ...
                <input
                  ...
                  name="name"
                  placeholder="Name"
                  className="form-input w-full block shadow-sm rounded border-gray bg-gray text-base p-2"
                />
              </div>
              <div>
              ...
              <div className="col-span-full">
                ...
                <textarea
                  ...
                  className="form-textarea resize-none w-full shadow-sm rounded border-gray bg-gray p-2"
                ></textarea>
              </div>
              <div>
                <button
                  type="submit"
                  className="py-2 px-6 rounded  text-base text-white font-semibold uppercase bg-primary "
                >
                  Send Message
                </button>
              </div>
          ...
          <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6">
            <div className="mx-auto max-w-xl flex flex-col space-y-5">
              <h2 className="text-4xl text-green uppercase ">Contact us</h2>
              <p className="text-sm ">
                Thank you for visiting our flower website! We're always happy to
                hear from our visitors, so please don't hesitate to get in touch
                with us if you have any questions, comments, or feedback. to get
                back to you as soon as possible.
              </p>
              <a
                href="#mail"
                className="flex justify-center text-sm text-blue-400 font-semibold hover:text-blue-500"
              >
                mail-contact@naturepalette.com
              </a>
